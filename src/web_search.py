...
class WebSearchTool:
    ...
    def _fallback_search(self, query: str) -> str:
        """
        Fallback search method (simulated for when no API key is available).
        ...
        return (
            ...
            "Note: Web search is not configured (no Tavily API key). "
            "In a production environment, this would search online forums, "
            "BoardGameGeek, and other Gloomhaven community resources for "
            "rule clarifications."
        )
